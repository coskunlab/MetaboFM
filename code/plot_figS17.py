...
plot_figS17.py
-------------
Supplementary Figure S17: HMDB Class Retrieval — Full Breakdown.
...
PANEL_DIR = OUT_DIR / "figS17_hmdb_extended"
...
CAPTION = """\
Supplementary Figure 17 | HMDB super-class retrieval performance across all annotated classes.
...
def main():
    ...
    save_panel(fig, "figS17_panelA_perclass_map10")
    plt.close(fig)

    # Panel B
    fig, ax = plt.subplots(figsize=(6.5, 6.5))
    draw_panel_b(ax, df_s2, df_s1)
    save_panel(fig, "figS17_panelB_scatter")
    plt.close(fig)
