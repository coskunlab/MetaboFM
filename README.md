...
Supplementary Figs. S12–S16 come from the H&E/MALDI-IHC comparison pipeline (see Pipeline step 7
above and `ARCHITECTURE.md`), run in a specific order rather than independently.
