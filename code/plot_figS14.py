...
CAPTION = """\
Supplementary Figure 14 | Extended sample retrieval gallery for Kidney, Brain, and Lung.
...
def main():
    ...
    for p in PANEL_DIR.glob("figS14_panelA_top_*.svg"):
        p.unlink()
    for p in PANEL_DIR.glob("figS14_panelA_hard_*.svg"):
        p.unlink()
